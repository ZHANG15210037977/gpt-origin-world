...
const PhaserType = typeof Phaser
...
const init = () => {
  ...
  function preload() {
    // 加载地图
    this.load.tilemapTiledJSON('map', '/src/assets/maps/clearMap.json')

    // 加载小人图像
    // 注意：这假设你的小人图像是一种sprite sheet，并且每个小人的大小是32x32
    // 如果不是，你需要调整这个设置以适应你的实际图片
    this.load.spritesheet('person', person1, { frameWidth: 16, frameHeight: 16 })
  }
  ...
  function create() {
    ...
    let person3 = this.physics.add.sprite(200, 100, 'person')
  }
}
